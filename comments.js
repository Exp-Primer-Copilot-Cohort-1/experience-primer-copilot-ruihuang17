...
var app = http.createServer(function(request,response){
  ...
  if(pathname === '/'){
    ...
    else if(pathname === '/create_process'){ // create_process
        var body = '';
    ...
    else if(pathname === '/update_process'){ // update_process
        var body = '';
        request.on('data', function(data){
            body = body + data;
        });
